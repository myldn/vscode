...
export const OPTIONS: OptionDescriptions<Required<NativeParsedArgs>> = {
	...
	'merge': { type: 'boolean', cat: 'o', alias: 'm', args: ['file', 'file', '[base]', 'output'], description: localize('merge', "Perform a three-way merge by providing paths for two modified versions of a file, the optional common base of both modified versions and the output file to save the merge result.") },
